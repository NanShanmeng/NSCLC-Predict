...
# Streamlit app title
st.title("Predicting the Risk of Non-Small Cell Lung Cancer")
...
if st.button("Predict"):
    ...
    # Set the class index (0 for negative, 1 for positive)
    ...
    # Print the expected_value and shap_values for debugging
    print("Expected Value:", explainer_shap.expected_value)
    print("SHAP Values:", shap_values)
    
    # Plot the force_plot for the predicted class
    st.subheader(f"SHAP Force Plot for Class {'Tumor' if class_idx == 1 else 'Normal'}")
    shap.force_plot(
